...
insert  into `krofna`(`id`,`kategorija_id`,`ime`,`recept`,`slika`,`kalorije`) values 
(1,1,'Nutela','brasno, jaja, secer,cokolada','cokoladna-krofna-ferero.png\r\n\Z\n',20),
(2,2,'Vannilalalla','Jaja,Brasno,Cimet,Vanila','./img/bakina.jpg',30);
